                ...
                <ul className="grid grid-cols-2 gap-2 sm:grid-cols-3 print:grid-cols-5 print:gap-x-[50px] print:gap-y-2">
                  {g.items.map((it) => {
                    ...
                    return (
                      <li
                        key={it.id}
                        className={`flex items-center justify-between gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-700 print:gap-2 print:rounded-none print:border-0 print:px-0 print:py-1 print:text-[28px] ${filled ? "print:border-b print:border-slate-200" : "print:opacity-50"}`}
                      >
