        ...
        <>
          ...
          <div className="space-y-4 print:space-y-1 print:mb-3">
            {visibleGroups.map((g) => (
              <div key={g.label} className="print:break-inside-avoid">
                <p className="tool-label-badge mb-1.5 text-xs font-semibold text-slate-500 print:mb-0.5 print:text-[28px] print:bg-black print:px-2 print:py-1 print:font-bold print:text-white">
                  {g.label}
                </p>
          ...
          {memo && memo.trim() !== "" && (
            <div className="print:break-inside-avoid rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 print:rounded-none print:border-0 print:border-t print:border-black print:bg-transparent print:px-0 print:pt-1.5">
              <p className="tool-label-badge mb-1 text-xs font-semibold text-slate-500 print:text-[28px] print:bg-black print:px-2 print:py-1 print:font-bold print:text-white">
                메모
              </p>
