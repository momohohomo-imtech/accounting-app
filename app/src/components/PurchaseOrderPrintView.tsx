      ...
      <div className="hidden rounded-2xl border border-slate-200 bg-white p-6 print:block print:rounded-none print:border-0 print:p-0">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-mono text-[11px] tracking-widest text-slate-400">PURCHASE ORDER</span>
          </div>
          <div className="flex text-center text-[11px]">
            {["담당", "검토", "승인"].map((label) => (
              <div key={label} className="-ml-px flex h-14 w-14 flex-col border border-slate-300 first:ml-0">
        ...
        <h1 className="mt-6 text-center text-3xl font-bold tracking-[0.5em] text-brand">발 주 서</h1>
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          <div className="rounded-lg border border-slate-300">
            <p className="border-b border-slate-300 bg-brand-soft px-3 py-1.5 text-xs font-semibold text-slate-600">매입처</p>
            <p className="px-3 py-3 text-sm font-medium text-slate-900">{purchaseOrder.clientName ?? "-"} 귀하</p>
          </div>
          <div className="rounded-lg border border-slate-300">
            <p className="border-b border-slate-300 bg-brand-soft px-3 py-1.5 text-xs font-semibold text-slate-600">발주자</p>
        ...
        <div className="mt-5 flex items-center justify-between rounded-lg border-2 border-brand bg-brand-soft px-4 py-3">
          <span className="text-sm font-semibold text-slate-700">발주금액</span>
          <span className="text-sm font-bold text-slate-900">
            {numberToKoreanAmount(total)} (<span className="font-mono">{formatWon(total)}</span>)
          </span>
        </div>

        <p className="mt-5 text-sm text-slate-700">아래와 같이 발주합니다.</p>
        ...
        <div className="mt-5 rounded-lg border border-slate-300">
          <p className="border-b border-slate-300 bg-brand-soft px-3 py-1.5 text-xs font-semibold text-slate-600">계약 조건</p>
          <div className="space-y-1.5 px-3 py-3 text-xs text-slate-700">
            <p>
            ...
            <div>
              ...
              <ol className="mt-1 list-none space-y-1 pl-1">
        ...
        {purchaseOrder.memo && (
          <div className="mt-4 rounded-lg border border-slate-200 p-3 text-sm">
            <p className="mb-1 text-xs font-semibold text-slate-500">라. 비고</p>
