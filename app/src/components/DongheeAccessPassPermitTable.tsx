...
export function DongheeAccessPassPermitTable({ items }: { items: DongheePermitItem[] }) {
  ...
  return (
    <div style={{ fontFamily: "'맑은 고딕', 'Malgun Gothic', sans-serif", fontSize: "4.5mm", color: "#000" }}>
      ...
      <table style={{ borderCollapse: "collapse", width: "100%", tableLayout: "fixed", marginTop: "4mm" }}>
        <colgroup>
          <col style={{ width: "8%" }} />
          <col style={{ width: "27%" }} />
          <col style={{ width: "12%" }} />
      ...
      <p style={{ textAlign: "center", fontSize: "3.6mm", margin: "6.2mm 0 0.9mm" }}>상기 물품의 반출을 확인함</p>
      <p style={{ textAlign: "center", fontSize: "3.6mm", margin: "0.9mm 0 2.7mm" }}>
        물품반입일 : 20&nbsp;&nbsp;&nbsp;년&nbsp;&nbsp;&nbsp;월&nbsp;&nbsp;&nbsp;일
      </p>

      <table style={{ borderCollapse: "collapse", width: "100%", tableLayout: "fixed", marginTop: "3.5mm" }}>
        <colgroup>
          <col style={{ width: "13%" }} />
          <col style={{ width: "87%" }} />
        </colgroup>
